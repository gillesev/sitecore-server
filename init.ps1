...
try {
    ...
    & $mkcert -install
    & $mkcert "*.sitecorejssserver.localhost"
...
Add-HostsEntry "cm.sitecorejssserver.localhost"
Add-HostsEntry "cd.sitecorejssserver.localhost"
Add-HostsEntry "id.sitecorejssserver.localhost"
Add-HostsEntry "meson.sitecorejssserver.localhost"
...
# CM_HOST
Set-EnvFileVariable "CM_HOST" -Value "cm.sitecorejssserver.localhost"

# CD_HOST
Set-EnvFileVariable "CD_HOST" -Value "cd.sitecorejssserver.localhost"

# ID_HOST
Set-EnvFileVariable "ID_HOST" -Value "id.sitecorejssserver.localhost"

# RENDERING_HOST
Set-EnvFileVariable "RENDERING_HOST" -Value "meson.sitecorejssserver.localhost"
...
# SITECORE_LICENSE
Set-EnvFileVariable "SITECORE_LICENSE" -Value (ConvertTo-CompressedBase64String -Path "c:\license\license.xml")
